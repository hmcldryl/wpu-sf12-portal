...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 22, fontWeight: "bold", color: "#0076cd", marginBottom: 8 },
  subtitle: { fontSize: 13, color: "#444", marginBottom: 4 },
  sectionTitle: { fontSize: 16, fontWeight: "bold", color: "#0076cd", marginBottom: 12 },
  ...
  tableHeaderRow: { flexDirection: "row", borderBottom: "2 solid #0076cd", paddingVertical: 4 },
  cell: { flex: 1, fontSize: 10 },
  cellHeader: { flex: 1, fontSize: 10, fontWeight: "bold", color: "#0076cd" },
